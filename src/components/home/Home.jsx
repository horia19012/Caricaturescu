...
import couple_image from "/src/assets/cuplu_caricatura.jpg";
import dog_image from "/src/assets/image2.jpg";
...
export default function Home() {
    ...
    const collections = [
        { img: couple_image, title: "Caricatura de cuplu" },
        { img: dog_image, title: "Caricatura cu cel mai bun prieten" },
        { img: couple_image, title: "Caricatura haioasa" },
        { img: dog_image, title: "Caricatura de grup" }
    ];
    ...
    return (
        <>
            ...
            <section className="collections" id="modele">
            ...
            <section className="newsletter" id="comanda">
                <div className="newsletter-content"
                     style={{display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column'}}>
                    <img src={logo} alt="Logo" style={{width: '300px', height: 'auto', marginBottom: '2rem'}}/>
                    <button className="order-btn" onClick={() => navigate("/comanda")}>
                        Comanda Acum
                        <i className="fas fa-arrow-right"></i>
                    </button>
                </div>
            ...
            {/* About */}
            <section className="about" id="despre_noi">
